...
SRCS = main.cpp MainMenu.cpp InGame.cpp PauseMenu.cpp Button.cpp State.cpp ChessBoard.cpp GamePieces.cpp GamePieces/Rook.cpp GamePieces/Pawn.cpp GamePieces/Knight.cpp GamePieces/Bishop.cpp GamePieces/Queen.cpp GamePieces/King.cpp Timer.cpp
OBJS = $(SRCS:.cpp=.o)
DEPS = $(SRCS:.cpp=.d)
